// NEW: accessible modal shell with backdrop + Esc close
"use client";
...
export default function Modal({ children, title = "Dialog" }: Props) {
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape") router.back(); // CHANGED: go back to previous route
    };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onClick={() => router.back()} // CHANGED: click backdrop to close
      />
