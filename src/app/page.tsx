    ...
    <PageLayout>
      ...
      <ContentCard className="bg-zinc-900">
        ...
        <p className="text-lg text-zinc-200">
          No matter where you are, online or in person,
          always let God be in your journey.
        </p>

        <div className="mt-6 grid grid-cols-1 gap-6 px-1 md:grid-cols-3">
          <GridCard title="Church Centre">
            <p>
              Want to join our church? Find our location
          ...
          <GridCard title="Live Streams">
            <p>
              Don't have time to come to church?
              Don't worry! We also have live streams
              every Sunday.
            </p>
            <button className={cardButtonClass}>
              Visit our channel →
          ...
          <GridCard title="Move to serve">
            <p>
              Serving could be hard at first, but we all
              start somewhere. Join us and learn more about
          ...
          >
            <p>
              Check out our latest series shared by our
              pastor, all in one blog page.
            </p>
            <button className={cardButtonClass}>
              Sermon series →
            </button>
      ...
      <ContentCard>
        ...
        <p className="mb-6 text-zinc-200">
          There are always new ways to participate in what
          God is doing through our life, including events,
          services, worship music, and so much more.
        </p>
        <ImageCarousel
          images={[
